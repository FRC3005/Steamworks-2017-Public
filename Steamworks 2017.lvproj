...
<Project Type="Project" LVVersion="16008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Deploy Tools" Type="Folder">
			<Item Name="bin" Type="Folder">
				<Item Name="plink.exe" Type="Document" URL="../Deploy Tools/bin/plink.exe"/>
				<Item Name="pscp.exe" Type="Document" URL="../Deploy Tools/bin/pscp.exe"/>
				<Item Name="RIOdroid.roborio.sh" Type="Document" URL="../Deploy Tools/bin/RIOdroid.roborio.sh"/>
				<Item Name="RIOdroid.tar.gz" Type="Document" URL="../Deploy Tools/bin/RIOdroid.tar.gz"/>
			</Item>
			...
			<Item Name="Constants Builder.vi" Type="VI" URL="../Deploy Tools/Constants Builder.vi"/>
			<Item Name="Set Constants Default.vi" Type="VI" URL="../Deploy Tools/Set Constants Default.vi"/>
			<Item Name="Get Private Global Path.vi" Type="VI" URL="../Deploy Tools/Get Private Global Path.vi"/>
		</Item>
		<Item Name="Path Gen" Type="Folder">
			<Item Name="Make Path Rear First.vi" Type="VI" URL="../Pathfinder/Make Path Rear First.vi"/>
			<Item Name="Unwrap Heading.vi" Type="VI" URL="../Pathfinder/Unwrap Heading.vi"/>
			<Item Name="VI Scripting Create Path.vi" Type="VI" URL="../Pathfinder/VI Scripting Create Path.vi"/>
		</Item>
		<Item Name="Android Deploy.vi" Type="VI" URL="../Deploy Tools/Android Deploy.vi"/>
		<Item Name="Path Generator.vi" Type="VI" URL="../Pathfinder/Path Generator.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Constants.lvlib" Type="Library" URL="../Constants/Constants.lvlib"/>
			<Item Name="Pathfinder.lvlib" Type="Library" URL="../Pathfinder/Pathfinder.lvlib"/>
			<Item Name="Path Template.vit" Type="VI" URL="../Auton/Paths/Path Template.vit"/>
		</Item>
	...
	<Item Name="Target" Type="RT myRIO">
		...
		<Property Name="CCSymbols" Type="Str">OS,Linux;CPU,ARM;DeviceCode,76F2;USING_VISION,TRUE;IS_PRACTICE_BOT,TRUE;TARGET_TYPE,RT;</Property>
...
DirectoryIndex index.htm
		...
		<Item Name="SubVI" Type="Folder">
			<Item Name="Team Code" Type="Folder">
				...
				<Item Name="Test Periodic.vi" Type="VI" URL="../Team Code/Test Periodic.vi"/>
			</Item>
			<Item Name="Pathfinder" Type="Folder">
				<Item Name="Pathfinder.lvlib" Type="Library" URL="../Pathfinder/Pathfinder.lvlib"/>
			</Item>
			<Item Name="Boolean Logic" Type="Folder">
				<Item Name="Latch on Rising.vi" Type="VI" URL="../Sub VI/Boolean/Latch on Rising.vi"/>
				<Item Name="Latch on Falling.vi" Type="VI" URL="../Sub VI/Boolean/Latch on Falling.vi"/>
			</Item>
			<Item Name="Elapsed Times.vi" Type="VI" URL="../Sub VI/Elapsed Times.vi"/>
			<Item Name="PIDF.vi" Type="VI" URL="../Sub VI/PIDF.vi"/>
			<Item Name="Drive Distance to Turn Angle.vi" Type="VI" URL="../Sub VI/Drive Distance to Turn Angle.vi"/>
			<Item Name="Turn Angle to Drive Distance.vi" Type="VI" URL="../Sub VI/Turn Angle to Drive Distance.vi"/>
			<Item Name="ChangeDriveTrainDeadband.vi" Type="VI" URL="../Sub VI/ChangeDriveTrainDeadband.vi"/>
			<Item Name="WPI_RobotDriveOpen1MotorWithSPARK.vi" Type="VI" URL="/&lt;vilib&gt;/Rock Robotics/WPI/RobotDrive/WPI_RobotDriveOpen1MotorWithSPARK.vi"/>
			<Item Name="Deadband Simple.vi" Type="VI" URL="../Sub VI/Deadband Simple.vi"/>
			<Item Name="WPI_RobotDriveMotors_3005_Fuel.vi" Type="VI" URL="../Drive6/WPI_RobotDriveMotors_3005_Fuel.vi"/>
			<Item Name="Joystick Sensitivity.vi" Type="VI" URL="../Sub VI/Joystick Sensitivity.vi"/>
		</Item>
		<Item Name="SubSystems" Type="Folder">
			<Item Name="Vision" Type="Folder">
				<Item Name="Adb Bridge.lvclass" Type="LVClass" URL="../Vision/AdbBridge/Adb Bridge.lvclass"/>
				<Item Name="Vision Server.lvclass" Type="LVClass" URL="../Vision/Vision Server/Vision Server.lvclass"/>
				<Item Name="Vision Drive.lvlib" Type="Library" URL="../Vision/Vision Drive/Vision Drive.lvlib"/>
			</Item>
			<Item Name="Shooter" Type="Folder">
				<Item Name="Shooter Controller.vi" Type="VI" URL="../SubSystems/Shooter/Shooter Controller.vi"/>
				<Item Name="Set Shooter.vi" Type="VI" URL="../SubSystems/Shooter/Set Shooter.vi"/>
				<Item Name="Shoot.vi" Type="VI" URL="../SubSystems/Shooter/Shoot.vi"/>
				<Item Name="Shooterqueue.ctl" Type="VI" URL="../SubSystems/Shooter/Shooterqueue.ctl"/>
				<Item Name="Get Shooter Queue.vi" Type="VI" URL="../SubSystems/Shooter/Get Shooter Queue.vi"/>
				<Item Name="Start Shooter.vi" Type="VI" URL="../SubSystems/Shooter/Start Shooter.vi"/>
			</Item>
			<Item Name="Auton" Type="Folder">
				<Item Name="Actions" Type="Folder">
					<Item Name="Encoder Drive Straight.lvclass" Type="LVClass" URL="../Auton/Actions/Encode Drive Straight/Encoder Drive Straight.lvclass"/>
					<Item Name="Auton Action Base.lvclass" Type="LVClass" URL="../Auton/Actions/Actions Base/Auton Action Base.lvclass"/>
					<Item Name="Drive 1D Profile.lvclass" Type="LVClass" URL="../Auton/Actions/Drive 1D Profile/Drive 1D Profile.lvclass"/>
				</Item>
				<Item Name="Modes" Type="Folder">
					<Item Name="Cross Line Only.lvclass" Type="LVClass" URL="../Auton/Modes/Cross Line Only/Cross Line Only.lvclass"/>
					<Item Name="Auton Mode Base.lvclass" Type="LVClass" URL="../Auton/Modes/Auton Mode Base/Auton Mode Base.lvclass"/>
				</Item>
				<Item Name="Paths" Type="Folder">
					<Item Name="Path Template.vit" Type="VI" URL="../Auton/Paths/Path Template.vit"/>
					<Item Name="Straight.vi" Type="VI" URL="../Auton/Paths/Straight.vi"/>
				</Item>
				<Item Name="Actual Routines" Type="Folder">
					<Item Name="Sensor_Camera Auton Simple.vi" Type="VI" URL="../Auton/Actual Routines/Sensor_Camera Auton Simple.vi"/>
				</Item>
				<Item Name="Auton Executor.lvclass" Type="LVClass" URL="../Auton/Executor/Auton Executor.lvclass"/>
			</Item>
			<Item Name="Constants.lvlib" Type="Library" URL="../Constants/Constants.lvlib"/>
			<Item Name="Drive System.lvlib" Type="Library" URL="../SubSystems/Drive/Drive System.lvlib"/>
			<Item Name="Path Track.lvlib" Type="Library" URL="../SubSystems/Path Track/Path Track.lvlib"/>
			<Item Name="Intake.lvlib" Type="Library" URL="../SubSystems/Intake/Intake.lvlib"/>
		</Item>
		...
		<Item Name="todelete.vi" Type="VI" URL="../Vision/Vision Drive/todelete.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
